...
angular.module('bookexcerptsApp').controller('AuthorDialogController',
    ['$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Author', 'Book',
        function($scope, $stateParams, $uibModalInstance, DataUtils, entity, Author, Book) {
        ...
        $scope.setPicture = function ($file, author) {
            ...
            if ($file) {
                ...
                fileReader.onload = function (e) {
                    ...
                    $scope.$apply(function() {
                        author.picture = base64Data;
                        author.pictureContentType = $file.type;
                    });
                };
            }
        };
