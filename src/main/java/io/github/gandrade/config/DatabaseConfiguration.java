package io.github.gandrade.config;

import io.github.gandrade.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("io.github.gandrade.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("io.github.gandrade.repository.search")
